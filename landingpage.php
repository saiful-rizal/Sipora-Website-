  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container position-relative d-flex align-items-center justify-content-between">
      ...
      <a href="index.html" class="logo d-flex align-items-center me-auto me-xl-0">
        ...
        <h1 class="sitename">SIPORA</h1><span>.</span>
      </a>
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li><a href="#portfolio">Koleksi</a></li>
          <li><a href="#pricing">Akses</a></li>
  ...
  <main class="main">
    ...
    <section id="hero" class="hero section dark-background">
        ...
        <div class="container">
          <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="100">
            <div class="col-lg-8 text-center">
              <h2>Sistem Informasi Polije Repositori Assets</h2>
              <p>Bangun kemudahan akses informasi akademik dan aset digital dengan Repository Polije yang modern, terstruktur, dan ramah pengguna</p>
      ...
      <div id="hero-carousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="5000">
        ...
        <div class="carousel-item">
          <img src="assets/img/slider/polije.jpg" alt="">
        </div>
    ...
    <section id="about" class="about section">
      ...
      <div class="container section-title">
        <h2>About</h2>
        <p>Polije Repository Assets adalah sistem informasi layaknya perpustakaan digital untuk mengelola, menyimpan, dan mengakses aset digital Politeknik Negeri Jember secara cepat dan terintegrasi.</p>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row g-5 align-items-center">
          ...
          <div class="col-lg-6" data-aos="fade-left">
            <h2 class="display-4 fw-bold mb-4">Polije Repository Assets</h2>
            <p class="lead mb-4">Sistem informasi repository layaknya perpustakaan digital untuk mengelola, menyimpan, dan mengakses aset digital Politeknik Negeri Jember secara mudah, cepat, dan terintegrasi.</p>
            ...
            <div class="features">
              <div class="feature-item mb-4" data-aos="fade-up">
                ...
                <div class="feature-content">
                  <h4>Akses Digital Mudah</h4>
                  <p>Memberikan kemudahan bagi civitas akademika dalam mencari, menyimpan, dan menggunakan aset digital kapan saja.</p>
                </div>
              </div>
              ...
              <div class="feature-item mb-4" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="feature-content">
                  <h4>Terintegrasi dan Efisien</h4>
                  <p>Mendukung pengelolaan data akademik dan non-akademik secara terpusat dengan tampilan yang responsif dan ramah pengguna.</p>
                </div>
              </div>

              <ul class="check-list" data-aos="fade-up" data-aos-delay="200">
                <li><i class="bi bi-check-circle"></i> Mendukung kolaborasi antar pengguna dalam pengelolaan data.</li>
                <li><i class="bi bi-check-circle"></i> Akses cepat dengan sistem modern yang aman.</li>
              </ul>
    ...
    <section id="services" class="services section">
      ...
      <div class="container section-title">
        <h2>Services</h2>
        <p>Akses cepat, aman, dan terintegrasi untuk mendukung kebutuhan akademik Polije.</p>
      </div><!-- End Section Title -->
        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="services-content" data-aos="fade-left" data-aos-duration="900">
              <span class="subtitle">Digital Repository</span>
              <h2>Meningkatkan Akses Informasi Melalui Layanan Repository</h2>
              <p data-aos="fade-right" data-aos-duration="800">Polije KRepository Assets menyediakan layanan penyimpanan, pencarian, dan pengelolaan aset digital yang mendukung kegiatan belajar, penelitian, dan pengembangan institusi.</p>
              <div class="mt-4" data-aos="fade-right" data-aos-duration="1100">
                <a href="service-details.html" class="btn-consultation"><span>Pelajari Layanan</span><i class="bi bi-arrow-right"></i></a>
              </div>
            </div>
          </div>
          <div class="col-lg-6">
              ...
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                  <div class="service-card">
                    ...
                    <a href="service-details.html" class="arrow-link"><i class="bi bi-arrow-right"></i></a>
                    <div class="content">
                      <h4><a href="service-details.html">Penyimpanan Aset Digital</a></h4>
                      <p>Menyediakan ruang aman untuk menyimpan berbagai dokumen, laporan, dan data akademik Polije.</p>
                ...
                <div class="swiper-slide">
                  <div class="service-card">
                    ...
                    <a href="service-details.html" class="arrow-link"><i class="bi bi-arrow-right"></i></a>
                    <div class="content">
                      <h4><a href="service-details.html">Akses Repository Online</a></h4>
                      <p>Memudahkan pengguna untuk mencari dan mengakses aset digital kapan saja dan di mana saja.</p>
                ...
                <div class="swiper-slide">
                  <div class="service-card">
                    ...
                    <a href="service-details.html" class="arrow-link"><i class="bi bi-arrow-right"></i></a>
                    <div class="content">
                      <h4><a href="service-details.html">Manajemen Data Terintegrasi</a></h4>
                      <p>Mengatur data secara sistematis agar mudah diakses dan mendukung efisiensi institusi.</p>
                ...
                <div class="swiper-slide">
                  <div class="service-card">
                    ...
                    <a href="service-details.html" class="arrow-link"><i class="bi bi-arrow-right"></i></a>
                    <div class="content">
                      <h4><a href="service-details.html">Inovasi &amp;Transformasi Digital</a></h4>
                      <p>Mendukung perubahan menuju sistem informasi modern layaknya perpustakaan digital terpusat.</p>
                ...
                <div class="swiper-slide">
                  <div class="service-card">
                    ...
                    <a href="service-details.html" class="arrow-link"><i class="bi bi-arrow-right"></i></a>
                    <div class="content">
                      <h4><a href="service-details.html">Kolaborasi dan Berbagi</a></h4>
                      <p>Mendorong kolaborasi antar civitas akademika melalui akses data bersama yang terintegrasi.</p>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-6" data-aos="fade-right" data-aos-delay="200">
            <div class="cta-content">
              ...
              <h2>Kelola & Akses Aset Digital Polije dengan Mudah</h2>
              <p class="lead">Polije KRepository Assets hadir sebagai pusat penyimpanan karya akademik, laporan penelitian, dan dokumen penting. Semua dalam satu sistem yang aman, cepat, dan terintegrasi.</p>
            </div>
          </div>
          ...
          <div class="col-lg-6" data-aos="fade-left" data-aos-delay="300">
            <div class="features-list mb-4">
              <div class="feature-item">
                ...
                <span>Repository Terpusat & Terstruktur</span>
              </div>
              <div class="feature-item">
                <i class="bi bi-check-circle-fill"></i>
                <span>Dapat di Akeses dari Mana Saja</span>
              </div>
              <div class="feature-item">
                <i class="bi bi-check-circle-fill"></i>
                <span>Mendukung Publikasi & Penelitian</span>
              </div>
            </div>
            ...
            <div class="trust-indicators mt-4">
              <small class="text-muted">Trusted by 500+ companies worldwide</small>
              <div class="rating">
                ...
                <i class="bi bi-star-fill"></i>
                <i class="bi bi-star-fill"></i>
                <span class="ms-2">4.9/5 (2,300+ reviews)</span>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-lg-5" data-aos="fade-right" data-aos-delay="200">
            <div class="features-content">
              <h2>Fitur Unggulan untuk Perpustakaan Modern</h2>
              <p>Akses koleksi digital kampus dengan cepat, mudah, dan efisien untuk mendukung penelitian serta pembelajaran mahasiswa dan dosen.</p>
              ...
              <div class="main-feature">
                ...
                <div class="feature-text">
                  <h4>Akses Cepat & Mudah</h4>
                  <p>Nikmati kecepatan pencarian koleksi dan interaksi tanpa hambatan untuk produktivitas akademik.</p>
                </div>
          ...
          <div class="col-lg-7" data-aos="fade-left" data-aos-delay="300">
            <div class="features-grid">
              <div class="feature-card" data-aos="zoom-in" data-aos-delay="400">
                ...
                <h5>Akses Koleksi Digital</h5>
                <p>Nikmati ribuan e-book, jurnal, dan referensi akademik dalam satu platform.</p>
              ...
              <div class="feature-card" data-aos="zoom-in" data-aos-delay="450">
                ...
                <h5>Statistik Pemakaian Real-time</h5>
                <p>Pantau data peminjaman dan penggunaan koleksi secara instan dan akurat.</p>
              </div><!-- End Feature Card -->
              ...
              <div class="feature-card" data-aos="zoom-in" data-aos-delay="500">
                ...
                <h5>Kolaborasi Mahasiswa & Dosen</h5>
                <p>Dukung diskusi akademik dengan fitur berbagi referensi dan catatan.</p>
              </div><!-- End Feature Card -->
              ...
              <div class="feature-card" data-aos="zoom-in" data-aos-delay="550">
                ...
                <h5>Keamanan Data</h5>
                <p>Melindungi informasi akademik dengan enkripsi modern dan kontrol akses, sehingga data tetap aman dari pihak yang tidak berwenang..</p>
              </div><!-- End Feature Card -->
              ...
              <div class="feature-card" data-aos="zoom-in" data-aos-delay="600">
                ...
                <h5>Pembelajaran Digitalan</h5>
                <p>Mendukung proses belajar mengajar dengan menyediakan akses mudah ke berbagai sumber pengetahuan dan referensi akademik terkini.</p>
              </div><!-- End Feature Card -->
              ...
              <div class="feature-card" data-aos="zoom-in" data-aos-delay="650">
                ...
                <h5>Manajemen Efisien</h5>
                <p>Pengelolaan aset akademik dilakukan secara terstruktur dan terintegrasi, sehingga memudahkan pencarian, penyimpanan, dan pemanfaatan data.</p>
              </div><!-- End Feature Card -->
            </div>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="swiper init-swiper">
          ...
          <div class="swiper-wrapper align-items-center">
            <div class="swiper-slide"><img src="assets/img/slider/1.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="assets/img/slider/2.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="assets/img/slider/3.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="assets/img/slider/4.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="assets/img/slider/5.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="assets/img/slider/6.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="assets/img/slider/7.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="assets/img/slider/8.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="assets/img/slider/9.png" class="img-fluid" alt=""></div>
          </div>
        </div>
